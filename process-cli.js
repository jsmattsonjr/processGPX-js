...
function setupYargsParser() {
	return yargs(hideBin(process.argv))
		...
		.options({
			...
			autoLoop: { type: "boolean", default: false, alias: ["autoLap"] },
			autoSpacing: { type: "boolean", default: undefined },
			copyPoint: { type: "boolean", default: false, alias: ["closed"] },
			csv: { type: "boolean", default: false },
			enableAdvancedSmoothing: { type: "boolean", default: false },
			enableElevationFixes: { type: "boolean", default: false },
			fixCrossings: { type: "boolean", default: undefined },
			loop: { type: "boolean", default: false, alias: ["lap"] },
			...
			autoSegmentDefaultPower: {
				type: "number",
				default: 0.5,
				alias: ["autoSegmentPower"],
			},
			...
			cornerCropEnd: { type: "number" },
			cornerCropStart: { type: "number" },
			cornerEffect: { type: "number", default: 1 },
			cropMax: { type: "number", alias: ["cropEnd", "crop", "cropStop"] },
			...
			fitArcs: { type: "boolean", default: undefined },
			fitArcsDegs: { type: "number", alias: ["fitArcsAngle"] },
			fitArcsDMax: { type: "number" },
			fitArcsEnd: { type: "number" },
			fitArcsStart: { type: "number" },
			fitArcsUniformGradient: { type: "boolean", default: undefined },
			...
			lAutoSmooth: { type: "number", default: 0, alias: ["autoSmoothL"] },
			...
			rUTurn: { type: "number" },
			shiftEnd: { type: "number", alias: ["laneShiftEnd"] },
			shiftSF: { type: "number", alias: ["laneShiftSF"], default: 0 },
			...
			spacing: { type: "number", alias: ["interpolate"] },
			splineDegs: { type: "number" },
			splineEnd: { type: "number" },
			splineInterpolation: { type: "boolean", default: undefined },
			splineMaxDegs: { type: "number", default: 60 },
			splineMaxRatio: { type: "number", default: 3 },
